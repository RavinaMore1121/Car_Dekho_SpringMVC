...
import carmvcpro.service.CarService;
...
public class CarController {
	...
	@PostMapping("/add")
	public String addCar(@SessionAttribute(name = "login", required = false)AdminPOJO admin, @RequestParam String name, @RequestParam String model, @RequestParam String brand, @RequestParam String fuel, @RequestParam double price, ModelMap map)
	{
		if (admin != null) 
		{
